...
import Daniel from 'assets/team/daniel-modified.png';
    ...
    <ThemeProvider theme={theme}>
      <StickyProvider>
        <Layout>
          ...
          <Grid sx={styles.grid}>
          <Box sx={styles.card}>
      <Image src={Daniel} sx={styles.memberThumb} />
      ...
      <Box sx={styles.socialShare} className="social__share">
          <Link  href='https://www.linkedin.com/in/daniel-clarke-01a1ab94/' >
            <FaLinkedinIn />
          </Link>
      </Box>
    </Box>
        <Box>
          <Text sx={styles.text}>
          Daniel is an AI technology
          leader with 15 years
          experience.
          As Head of Applied Science
          at Adarga he led the
          development of the AI
          technology at the core of the
          Adarga Knowledge platform.
          This included building the
          core NLP and knowledge
          graph technologies.
          </Text>
        </Box>
        </Grid>
